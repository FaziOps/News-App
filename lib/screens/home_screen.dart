...
class _VideoNews {
  ...
  static const List<_VideoNews> list = [
    _VideoNews(
      title: 'The power of vulnerability',
      thumbnailUrl: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=500&q=80',
    ...
    _VideoNews(
      ...
      thumbnailUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=500&q=80',
    ...
    _VideoNews(
      ...
      thumbnailUrl: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=500&q=80',
...
class _LiveChannel {
  ...
  static const List<_LiveChannel> list = [
    _LiveChannel(
      name: 'BBC News',
      liveUrl: 'https://www.youtube.com/watch?v=y60wDzZt8yg',
      fallbackUrl: 'https://www.youtube.com/user/bbcnews/live',
    ),
    _LiveChannel(
      name: 'CNN',
      liveUrl: 'https://www.youtube.com/watch?v=s9f8tF9b5i0',
      fallbackUrl: 'https://www.youtube.com/cnn/live',
    ),
    _LiveChannel(
      name: 'Geo News',
      liveUrl: 'https://www.youtube.com/watch?v=34d7KjC7gaw',
      fallbackUrl: 'https://www.youtube.com/geonews/live',
    ),
    _LiveChannel(
      name: 'Al Jazeera',
      liveUrl: 'https://www.youtube.com/watch?v=gCNeDWCI0vo',
      fallbackUrl: 'https://www.youtube.com/aljazeera/live',
    ),
    _LiveChannel(
      name: 'Dunya News',
      liveUrl: 'https://www.youtube.com/watch?v=Vl0Bpl26Lms',
      fallbackUrl: 'https://www.youtube.com/dunyanews/live',
    ),
  ];
}
    ...
    return SafeArea(
      ...
      child: CustomScrollView(
        slivers: [
          ...
          // Latest video news Section Header
          SliverToBoxAdapter(
            child: Padding(
          ...
          // Latest video news Horizontal List
          SliverToBoxAdapter(
            child: SizedBox(
              height: 220,
              child: ListView.builder(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 16),
                itemCount: _VideoNews.list.length,
                itemBuilder: (context, index) {
                  final video = _VideoNews.list[index];
                  return Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          // Publisher/channel name (redirects to channel)
                          GestureDetector(
                            onTap: () async {
                              final uri = Uri.parse(video.channelUrl);
                              await launchUrl(uri, mode: LaunchMode.externalApplication);
                            },
                            child: Text(
                              video.publisher,
          ...
          // Live news channels Section Header
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20.0, 24.0, 20.0, 12.0),
              child: Column(
          ...
          // Live news channels Horizontal List
          SliverToBoxAdapter(
            child: SizedBox(
              height: 140,
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                padding: const EdgeInsets.symmetric(horizontal: 16),
                itemCount: _LiveChannel.list.length,
                itemBuilder: (context, index) {
                  final channel = _LiveChannel.list[index];
                  return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFFC61A09),
                          borderRadius: BorderRadius.circular(20),
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFFC61A09).withOpacity(0.2),
                              blurRadius: 8,
